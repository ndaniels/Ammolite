...
import moonstone.compression.MoleculeStructFactory;
import moonstone.compression.StructCompressor;
import moonstone.compression.StructDatabaseDecompressor;
import moonstone.search.ParallelSearcher;
