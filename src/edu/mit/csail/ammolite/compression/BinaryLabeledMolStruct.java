...
public class BinaryLabeledMolStruct extends AtomContainer implements IMolStruct {
    ...
    public BinaryLabeledMolStruct() {}
    
    public BinaryLabeledMolStruct(IAtomContainer base){
    ...
    public boolean isIsomorphic(IAtomContainer struct, AbstractIsomorphismTester tester) {
        if(tester instanceof LabeledVF2IsomorphismTester){
            if(struct instanceof BinaryLabeledMolStruct){
                BinaryLabeledMolStruct that = ((BinaryLabeledMolStruct) struct);
