...
public class BinaryLabeledCyclicStruct extends BinaryLabeledMolStruct {

    public BinaryLabeledCyclicStruct() {
        // TODO Auto-generated constructor stub
    }

    public BinaryLabeledCyclicStruct(IAtomContainer base) {
        super(base);
